...
export function generateProductSchema(product: any) {
  const productUrl = `${SITE_CONFIG.domain}/product/${product.slug || product.id}`;
  ...
  return {
    ...
    offers: {
      ...
      url: productUrl,
      priceCurrency: "INR",
      price: product.sellingPrice || product.retailPrice || 0,
...
export const DEFAULT_SEO_CONFIG: Record<string, SEOConfig> = {
  ...
  cart: {
    ...
    description: "Review your items and send your order on WhatsApp",
    robots: "noindex, follow",
  },
  checkout: {
    title: "WhatsApp Order | Bluebell Gifts",
    description: "Send your selected products to Bluebell Gifts on WhatsApp",
    robots: "noindex, follow",
  },
};
