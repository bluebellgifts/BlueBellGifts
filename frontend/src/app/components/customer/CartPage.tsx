        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-600 mb-8 max-w-md mx-auto">
              Add products to your cart and send the order on WhatsApp.
            </p>
            <Button
              variant="primary"
              size="lg"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-slate-600 mt-1">
            {cart.length} item{cart.length !== 1 ? "s" : ""} ready to order on
            WhatsApp
          </p>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="space-y-3 md:space-y-4">
              {cart.map((item) => {
                ...
                const retailPrice = item.product.retailPrice || price;
                const productImage = getProductImage(item.product);
                const availableStock =
                  item.product.stock ?? item.product.stockQuantity ?? 999;
                        ...
                        <div className="flex items-center justify-between gap-2 mt-3 flex-wrap">
                          <div className="flex items-center border border-slate-200 rounded-lg h-9">
                            ...
                            <button
                              ...
                              className="px-2 md:px-3 h-full hover:bg-slate-50 transition-colors flex items-center justify-center disabled:opacity-50"
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4 md:p-5 lg:sticky lg:top-24">
              ...
              <div className="mt-4 p-3 bg-emerald-50 rounded-lg border border-emerald-200">
                <p className="text-xs md:text-sm text-emerald-700 font-medium">
                  Checkout will open WhatsApp with your selected cart items
                  prefilled.
                </p>
              </div>
            </div>
